...
class RAccountPage extends StatefulWidget {
  const RAccountPage({super.key});

  @override
  State<RAccountPage> createState() => _RAccountPageeState();
}

class _RAccountPageeState extends State<RAccountPage> {
  XFile? image;
  int selectedPos = 3;
